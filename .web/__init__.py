...
def get_avatar(avatar_id, path):
  ...
  return get_avatar({'default': 0, 'origin': 9918, 'vip': 23203, 'striker': 23209, 'terminating': 23226,
    ...
    'lenny-the-pirate': 25161, 'skadrin-ash': 25223, 'dark-monarch': 25224, 'soul-briar': 25225, 'mischievous': 25227, 'forest-protector': 25228, 'ice-box': 25229}.get(str(avatar_id).lower().replace(' ', '-').replace("'", ''), 0), path)
