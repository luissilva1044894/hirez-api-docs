...
<table>
  ...
  <tr><td>485</td><td>Custom Siege - Warders Gate</td><td>This version of Custom <a href="#game-modes-paladins-siege-description">Siege</a> allows players to open up own matches - with own game settings.<br/>But no game progress can be achieved in these matches.</td><td><img src="./../_assets/paladins/maps/warders-gate.png" height="75" width="75"/></td></tr>
